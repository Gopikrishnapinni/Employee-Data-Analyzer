...
public class EmployeeDataAnalyzer {
    public static void main(String[] args) {
        ...
        employeeManager.addEmployee(new Employee(1, "Gopikrishna", "Engineering", 75000.0));
        employeeManager.addEmployee(new Employee(2, "Akash", "Marketing", 68000.0));
        employeeManager.addEmployee(new Employee(3, "Srinu", "Engineering", 80000.0));
        employeeManager.addEmployee(new Employee(4, "Chinna", "HR", 55000.0));
